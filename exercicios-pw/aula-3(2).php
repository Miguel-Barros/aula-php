...
<body>
    ...
    <div class="container">
        ...
        <?php 
            $notas = [1 => $_POST['nota-1'], 2 => $_POST['nota-2'], 3 => $_POST['nota-3'], 4 => $_POST['nota-4'], 5 => $_POST['nota-5']];
            $mencao = ""; 
            $media = ($notas[1] + $notas[2] + $notas[3] + $notas[4] + $notas[5]) / 5;
            if($media <= 4){$mencao = "I";}elseif ($media <= 7){$mencao = "R";}elseif ($media <= 9){$mencao = "B";}elseif ($media == 10){$mencao = "MB";}
            echo "<h2>Sua menção escolar é ($mencao), que equivale a uma nota ($media)</h2>";
        ?>
            <div class="feedback"><img style="opacity: .8;" src="https://upload.wikimedia.org/wikipedia/commons/d/d1/Batman.png"></div>
        </div>
    </div>
    <footer>
        <p>2022 © Miguel B.</p>
