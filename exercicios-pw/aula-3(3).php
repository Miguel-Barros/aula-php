...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <?php
            $raio = $_POST['valor-r'];
            $area = number_format((3.14 * ($raio * $raio)), 2, '.', '');
            echo "<h2>A area de um circulo de raio ($raio) é de ($area)</h2>";
            ?>
            <div class="feedback"><img style="opacity: .8;" src="https://pt.seaicons.com/wp-content/uploads/2016/03/witch-hat-icon-1.png"></div>
        </div>
    </div>
    <footer>
        <p>2022 © Miguel B.</p>
