...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            $x = $_POST['valor-x'];
            $y = $_POST['valor-y'];
            $hip = number_format((sqrt(($x ** 2) + ($y ** 2))), 2, '.', '');
            echo "<h2>A hipotenusa do seu triângulo retângulo com (B = $x ) e (C = $y ) é de $hip </h2>";
            ?>
            <div class="feedback"><img style="opacity: .8;" src="https://www.seekpng.com/png/detail/61-615728_bruxa-em-png-madrasta-cute-espelho-castelo-anoes.png"></div>
        </div>
    </div>
    <footer>
        <p>2022 © Miguel B.</p>
