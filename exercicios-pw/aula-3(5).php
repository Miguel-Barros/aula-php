    ...
    <div class="container">
        ...
        <div class="main">
            ...
            if ($letra == "A" or $letra == "E" or $letra == "I" or $letra == "O" or $letra == "U") {
                // vogal
                echo "<h2>A letra digitada foi ($letra) que é uma Vogal.</h2>";
            } else {
                //consoante
                echo "<h2>A letra digitada foi ($letra) que é uma Consoante.</h2>";
            }
            ?>
            <div class="feedback"><img style="opacity: .8;" src="https://diariodospapais.com.br/wp-content/uploads/2012/11/Tyrone-backyardigans.jpg"></div>
        </div>
    </div>
    <footer>
        <p>2022 © Miguel B.</p>
