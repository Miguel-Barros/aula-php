...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <?php
            $numeros = ["Primeiro" => $_POST['number-1'], "Segundo" => $_POST['number-2'], "Terceiro" => $_POST['number-3']];
            echo "<h2>Ordem crescente</h2>";
            asort($numeros);
            foreach ($numeros as $chave => $valor) {
                echo "<p>Numero: $valor</p>";
            }
            echo "<h2 style='margin-top: 15px;'>Ordem decrescente</h2>";
            rsort($numeros);
            foreach ($numeros as $chave => $valor) {
                echo "<p>Numero: $valor</p>";
            }
            ?>
            <div class="feedback"><img src="https://imagensemoldes.com.br/wp-content/uploads/2020/03/Winnie-the-Pooh-Ursinho-Pooh-Tigr%C3%A3o-PNG-17.png"></div>
        </div>
    </div>
    <footer>
        <p>2022 © Miguel B.</p>
