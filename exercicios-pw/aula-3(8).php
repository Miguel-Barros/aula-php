...
<body>
    ...
    if($imc <= 18.4){
        //abaixo
        echo "<h2>Seu IMC é $imc, você esta abaixo do peso.</h2>";
    }elseif($imc >= 18.5 and $imc <= 24.9){
        //peso normal
        echo "<h2>Seu IMC é $imc, você esta com o peso ideal.</h2>";
    }elseif($imc >= 25.0 and $imc <= 29.9){
        // sobrepeso
        echo "<h2>Seu IMC é $imc, você esta com sobrepeso.</h2>";
    }elseif($imc >= 30.0 and $imc <= 34.9){
        //Obesidade grau 1
        echo "<h2>Seu IMC é $imc, você esta com obesidade grau 1.</h2>";
    }elseif($imc >= 35.0 and $imc <= 39.9){
        //obesidade grau 2
        echo "<h2>Seu IMC é $imc, você esta com obesidade grau 2.</h2>";
    }elseif($imc >= 40.0){
        //obesidade grau 3
        echo "<h2>Seu IMC é $imc, você esta com obesidade grau 3.</h2>";
    }
?>
