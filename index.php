            ...
            <div class="container w-50">
                <nav class="d-flex justify-content-center py-3">
                    <ul class="nav nav-pills">
                        <li class="nav-item me-5"><a href="#" class="nav-link ">Explore</a></li>
                        <li class="nav-item me-5"><a href="#" class="nav-link ">Sobre</a></li>
                        <li class="nav-item me-5"><a href="#" class="nav-link"><img class="logo" src="https://img.freepik.com/vetores-gratis/identidade-de-marca-identidade-corporativa-logo-m-design_460848-10168.jpg" alt=""></a></li>
    ...
    <section class="about">
        ...
        <div class="container" data-aos="fade-left" data-aos-duration="1500">
            <div class="row row-cols-2">
                <div class="col"><p>Cria da Pavuna na Zona Norte do RJ e em 2019 conseguiu colocar uns sons para rodar incluindo “Five Black”, “C. Walk” e “Range Rover”, mas foi “Ak do Flamengo” que colocou NGC Borges no radar de todos e está indicando um 2020 recheado de sons e participações.</p></div>
                <div class="col">
